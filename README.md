- [kubernetes-engineer](#kubernetes-engineer)
  * [Kubernetes](#kubernetes)
    + [What happens when one types kubectl -f deployment.yaml](#what-happens-when-one-types-kubectl--f-deploymentyaml)
    + [Clusters](#clusters)
    ...
    + [Accessing applications hosted in Kubernetes](#accessing-applications-hosted-in-kubernetes)
      - [Port forwarding](#port-forwarding)
    + [Pod controllers](#pod-controllers)
    + [RBAC](#rbac)
    + [APIs](#apis)
    + [Multitenancy and cluster hardening](#multitenancy-and-cluster-hardening)
    + [Secret](#secret)
    + [ConfigMap](#configmap)
    + [Admission controllers](#admission-controllers)
    + [Ingress solutions](#ingress-solutions)
    + [CRDs](#crds)
  * [Programming](#programming)
    ...
    + [Data structures](#data-structures)
      ...
      - [Arrays](#arrays)
    + [Code availability and reliability](#code-availability-and-reliability)
    + [Pointers](#pointers)
    + [Systems level architecture of distributed or similar systems](#systems-level-architecture-of-distributed-or-similar-systems)
  ...
  * [Systems](#systems)
    ...
    + [OOM and resource limits](#oom-and-resource-limits)
...
### Memory issues 
### Cache algorithms
Official documentation: <https://searchstorage.techtarget.com/definition/cache-algorithm>
